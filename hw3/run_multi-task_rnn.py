...
tf.app.flags.DEFINE_string("mode", None, "Options: test; train")
tf.app.flags.DEFINE_string("answer", None, "answer file name")
...
def dump_intent(output_list, filename):
...
def train():
  ...
  current_labeling_test_out_file = result_dir + '/labeling.test.hyp.txt'
  ...
  with tf.Session() as sess:
    ...
    # Run evals on development/test set and print the accuracy.
      ...
      if task['intent'] == 1:
        ...
        if mode == 'Test':
          dump_intent(hyp_label_list, current_labeling_test_out_file)
    ...
    if FLAGS.mode == "test":
      ...
      current_taging_test_out_file = FLAGS.answer
      current_labeling_test_out_file = FLAGS.answer
      ...
      while model.global_step.eval() < FLAGS.max_training_steps:
        ...
        if current_step % FLAGS.steps_per_checkpoint == 0:
          ...
          if task['intent'] == 1 and valid_accuracy > best_valid_score:
            ...
            subprocess.call(['mv', current_labeling_test_out_file, current_labeling_test_out_file +  '.best_val_acc_%.2f' % best_valid_score])
          ...
          if task['tagging'] == 1 and valid_tagging_result['f1'] > best_valid_score:
            ...
            subprocess.call(['mv', current_taging_test_out_file, current_taging_test_out_file +  '.best_val_f1_%.2f' % best_valid_score])
